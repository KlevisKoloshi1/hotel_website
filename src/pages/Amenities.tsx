...
import { Bath, Dumbbell, Utensils, Wine, Coffee, Clock, Car, Plane, Car as CarIcon, MapPin, Waves, Users, Music, BookOpen, Heart } from "lucide-react";
...
export default function Amenities() {
  ...
  const getIcon = (categoryName: string, index: number) => {
    const icons = {
      wellness: [<Bath key={0} />, <Dumbbell key={1} />, <Waves key={2} />, <Heart key={3} />],
